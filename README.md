...
pixi add metadata-crawler
# for installing globally
pixi global install metadata-crawler
```
...
It is possible to list all of the versions of `metadata-crawler` available on your platform:
...
```
pixi search metadata-crawler --channel conda-forge
```
